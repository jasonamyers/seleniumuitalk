...
class test_ui_functions(unittest.TestCase):
    ...
    def test_shipping_quote(self):
        shipping_quote_test_info = {
            'test_type': 'shipping_quote',
            'tests': {
                '1' : {
                    'shipping_state' : 'Tennessee',
                    'shipping_postal_code' : '37128',
        ...
        for test in shipping_quote_test_info['tests']:
            test_type = shipping_quote_test_info['test_type']
            current_test = shipping_quote_test_info['tests'][test]
            self.result = run_test(self.driver, current_test, test_type)
            self.assertTrue(self.result)
